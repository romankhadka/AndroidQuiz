...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionTextView1.setText("Question 1: What is the capital of France?")
        questionTextView2.setText("Question 2: Which programming languages are used in Android development?")
